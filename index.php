  ...
  <section class="island-map-section container">
    ...
    <div class="island-map">
      ...
      <div class="island-card island-thalassos" data-act="I">
        ...
        <?php if ($isLoggedIn): ?>
          <a href="jogar.php" class="island-cta" data-i18n="home.island_explore"><?= t('home.island_explore') ?></a>
        <?php else: ?>
  ...
  <section class="cta-section container">
    <div class="cta-box">
      ...
      <div class="cta-actions">
        <a href="register.php" class="btn btn-primary btn-lg" data-i18n="home.cta_register"><?= t('home.cta_register') ?></a>
        <a href="historia.php" class="btn btn-ghost btn-lg" data-i18n="home.cta_story"><?= t('home.cta_story') ?></a>
      </div>
    </div>
  </section>
  <?php endif; ?>
