    ...
    <?php if ($q !== ''): ?>
      ...
      <?php if ($total === 0): ?>
        <div class="search-empty">
          ...
          <p>Nenhum aventureiro encontrado para "<strong><?php echo e($q); ?></strong>".</p>
        </div>

      <?php else: ?>
        <p class="search-count">
          <?php echo $total <= 30 ? $total : '30+'; ?> resultado<?php echo $total !== 1 ? 's' : ''; ?>
          para "<strong><?php echo e($q); ?></strong>"
        </p>
        ...
        <div class="search-results">
          <?php foreach ($results as $r): ?>
            <?php
              ...
              $roleLabel = $r['role'] === 'admin' ? 'Admin' : 'Aventureiro';
            ?>
            <a href="u.php?u=<?php echo urlencode($r['username']); ?>" class="search-card">
              ...
              <div class="search-info">
                ...
                <span class="search-role"><?php echo $roleLabel; ?></span>
                <?php if ($level): ?>
                  <span class="search-stats">
                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>
                    Nível <?php echo $level; ?>
                    <?php if ($chapter): ?> · <?php echo e($chapter); ?><?php endif; ?>
                  </span>
                <?php else: ?>
                  <span class="search-stats" style="color:var(--faint)">Sem saves registados</span>
                <?php endif; ?>
              </div>
        ...
        <?php if ($total > 30): ?>
          <p class="search-more">Mostrando os primeiros 30 resultados. Refina a pesquisa para encontrar quem procuras.</p>
        <?php endif; ?>

      <?php endif; ?>

    <?php elseif ($q === '' && isset($_GET['q'])): ?>
      <p class="search-hint">Introduz pelo menos 2 caracteres para pesquisar.</p>
    <?php endif; ?>
